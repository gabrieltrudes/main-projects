                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
                            ...
                            <div class="jumbotron mt-5">
                                ...
                                <h5><span class="badge badge-dark">Horário: 09h00</span></h5>
                        ...
                        <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
                            ...
                            <div class="jumbotron mt-5">
                                ...
                                <hr>
                                <p>
                                Para atender ao desafio do processamento de dados de maneira rápida e 
                                segura, surgiu o conceito de Edge Computing, ou computação de borda. 
                                A borda aqui se refere a todo dispositivo conectado que produz dados – 
                                dados esses que serão processados e concentrados em um servidor local, 
                                com acesso à energia segura e dimensionada para algumas poucas aplicações 
                                específicas. Por isso, é importante separar o que pode ser enviado para 
                                a nuvem, e o que necessita de atenção especial e tomadas de decisão 
                                rápidas.
                                </p>
                                                               
                                <a href="#palestrantes"><h6>Palestrante: Alan Satudi (Schneider Electric)</h6></a>
                                <h5><span class="badge badge-dark">Horário: 09h15</span></h5>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
                            ...
                            <div class="jumbotron mt-5">
                                ...
                                <a href="#palestrantes"><h6>Palestrante:Prof. Dr. Edison Monteiro (UNIP - Santos)</h6></a>
                                <h5><span class="badge badge-dark">Horário: 19h15</span></h5>
                            </div>
                        ...
                        <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
                            ...
                            <div class="jumbotron mt-5">
                                ...
                                <h5><span class="badge badge-dark">Horário: 19h30</span></h5>
                            </div>
                            ...
                            <div class="carousel-item">
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-8 col-sm-10 col-10 align-self-center">
                                        ...
                                        <p>
                                            Formado em Engenharia Elétrica pela Faculdade de Engenharia São Paulo, Alan Satudi é gerente de Marketing de Produtos da Schneider Electric. Há mais de 15 anos atuando na companhia, o executivo tem ampla experiência em infraestrutura elétrica, física e de climatização de precisão para sistemas de missão crítica, principalmente data centers.
                                        </p>
